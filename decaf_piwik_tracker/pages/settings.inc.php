...
<div class="rex-addon-output">
  <div id="rex-addon-editmode" class="rex-form">
    <form action="" method="post">
        ...
        <div class="rex-form-wrapper">
          ...
          <div class="rex-form-row">
            <p class="rex-form-col-a rex-form-text">
              ...
              <span class="rex-form-notice"><?php echo $I18N->msg('piwik_tracker_url_notice'); ?></span>
            </p>
          </div>
          <div class="rex-form-row">
            <p class="rex-form-col-a rex-form-text">
              ...
              <span class="rex-form-notice"><?php echo $I18N->msg('piwik_site_id_notice'); ?></span>
            </p>
          </div>
          <div class="rex-form-row">
            <p class="rex-form-col-a rex-form-text">
              ...
              <span class="rex-form-notice"><?php echo $I18N->msg('piwik_token_auth_notice'); ?></span>
            </p>
          </div>
          <div class="rex-form-row">
            <p class="rex-form-col-a rex-form-select">
              ...
              <span class="rex-form-notice"><?php echo $I18N->msg('piwik_tracking_method_notice'); ?></span>
            </p>
          </div>
        </div>
      </fieldset>
      ...
      <fieldset class="rex-form-col-1">
        <legend><?php echo $I18N->msg('piwik_login_legend'); ?>:</legend> 
        <div class="rex-form-wrapper"> 
          <div class="rex-form-row">
            <p class="rex-form-col-a rex-form-text">
